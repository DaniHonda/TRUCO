...
module.exports = async (req, res) => {
    ...
    // Define qual origem (site) tem permissão para acessar este backend.
    res.setHeader('Access-Control-Allow-Origin', 'https://truco-rosy.vercel.app');
    // Quais métodos HTTP são permitidos.
    res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS');
    // Quais cabeçalhos são permitidos.
    res.setHeader('Access-Control-Allow-Headers', 'Content-Type');

    // O método OPTIONS é uma "pré-requisição" que o navegador envia para checar as permissões.
    // Se a requisição for OPTIONS, apenas respondemos que está tudo OK.
